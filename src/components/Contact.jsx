...
//           <a href='mailto:suneelgokada@gmail.com' className='border-b'>{CONTACT.email}</a>
//         </motion.div>
//       </div>
//     </div>
//   );
  ...
  const onSubmit = async (event) => {
    ...
    try {
      await emailjs.sendForm(
        "service_cnr2y1b",   // replace
        "Suneel_portfolio_email_t",  // replace
        form,
        "QyNjd4uLpeelOfqXO"    // replace
      );
  ...
  return (
    <div className="pb-15 relative" id="contact">
      ...
      <form onSubmit={onSubmit}>
        ...
        <p className='items-center mx-auto justify-center flex text-2xl my-6'>
          {result}
        </p>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center text-center mt-10 gap-4 sm:gap-8 lg:gap-12 pb-20">
        ...
        >
          <FaEnvelope className="text-slate-400" />
          <a href='mailto:suneelgokada@gmail.com' className='border-b'>
            {CONTACT.email}
          </a>
        </motion.div>
