...
import resume from '../assets/Gokada_Sunil_CV.pdf'
      ...
      <div className='flex flex-wrap'>
        <div className='w-full lg:w-1/2'>
          <div className='flex flex-col items-center lg:items-start'>
            <motion.h1 variants={animationCon(0)} initial="hidden" animate='visible' className='text-3xl font-thin tracking-tight lg:mt-16 lg:text-6xl'>Suneel Gokada</motion.h1>
        ...
        <div className='w-full lg:w-1/2 lg:p-8 '>
          <div className='flex justify-center '>
            <motion.img initial={{ x: 100, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 1, delay: 1.25 }} src='../src/assets/suneelpic2.jpeg' alt="profile" />
          </div>
